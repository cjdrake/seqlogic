...
from seqlogic import Enum, Struct, Vec, add, cat, eq, le, sub, xt
...
class RoundMode(Enum):
    NEAR_EVEN = "3b000"  # round to nearest, with ties to even
    MIN_MAG = "3b001"  # round to minimum magnitude (toward zero)
    MIN = "3b010"  # round to minimum (down)
    MAX = "3b011"  # round to maximum (up)
    NEAR_MAX_MAG = "3b100"  # round to nearest, with ties to maximum magnitude (away from zero)
    ODD = "3b110"  # round to odd (jamming)
